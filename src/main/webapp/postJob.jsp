	...
	<form action="PostJobController" method="post">
		<div class="form-box">
			...
			<input type="number" name="companyid" placeholder="Company Id"
				pattern="[0-9]{3}" required><br>
			<br> <input type="text" name="jobtitle" placeholder="Job Title"
				pattern="[A-Za-z., ]{3,30}" autofocus required><br>
			<br> <input type="number" name="salary"
				placeholder="Enter Salary" required><br>
			<br> <input type="text" name="experience"
				placeholder="Enter Experience" pattern="[0-9 ][A-Za-z ]{3,7}"
				required><br>
			<br> <input type="text" name="category"
				placeholder="Enter Job Category" pattern="[A-Za-z]{3,30}" required><br>
