	...
	<form action="CompanyRegisterController" method="post">
		<div class="form-box">
			...
			<input type="number" name="companyid" placeholder="Company Id"
				pattern="[0-9]{3}" autofocus required><br>
			<br> <input type="text" name="companyname"
				placeholder="Company Name" pattern="[A-Za-z.,'@ ]{3,30}" required><br>
			<br> <input type="text" name="username" placeholder="User Name"
				pattern="[A-Za-z., ]{3,30}" required><br>
			<br> <input type="text" name="userrole" placeholder="UserRole"
				pattern="[A-Za-z' ]{2,30}" required><br>
			<br> <input type="number" name="phonenumber"
				placeholder="Phone Number" pattern="[0-9]{10}" required><br>
			<br> <input type="text" name="location" placeholder="Location"
				pattern="[A-Za-z.' ]{3,30}" required><br>
			<br> <input type="email" name="mailid" placeholder="Email Id"
				id="mailid" required onkeyup="emailvalid()"><br>
			<br>
			...
			<br> <input type="submit" style="background-color: red"
				value="Login">
			<p class="backlink">
				Already have an account ?<a href="companyLogin.jsp">Login</a>
			</p>
		</div>
