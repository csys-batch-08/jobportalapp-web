...
<table border="2" id="alljobs" class="table" >
			...
			<br>
				...
				<tr>
					...
					<td class="table-primary"><c:out value="${current.getApplicantName()}" /></td>
					<td class="table-info"><c:out value="${current.getEmail()}" /></td>
					<td class="table-warning"><c:out value="${current.getPhoneNumber()}" /></td>
					<td class="table-active"><c:out value="${current.getApplicantId()}" /></td>										
					<td class="table-secondary"><c:out value="${current.getDate()}" /></td>
					<td class="table-warning"><c:out value="${current.getStatus()}" /></td>
					</tr>
					</c:forEach>
					</tbody>
		           </table>
