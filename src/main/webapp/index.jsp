...
<p id="firstP">This is one of the fastest growing networks. Hire skilled people or get hired by the top companies. </p>
   <img id="img" src="Assets/3.jpg" alt="no img">
   <br>
   <br>		
<strong><p id="p2"><span id="seeker">Job Seeker : </span> </strong>Technology has changed the way job seekers search for jobs and employers find qualified employees. 
...
<h2 class="p3">Create economic opportunity for every member of the global workforce.</h2>    

<h2 class="p3">The mission is simple connect the world's professionals to make them more productive and successful.</h2><br>    
<hr class="new2">
<p></p><h2 id="p4">About Us</h2><p></p>
<p id="p5">Jobs by Skill-Call Center Jobs | Mechanical Engineering Jobs | Biotechnology Jobs | Nursing Jobs | BPO Jobs | Networking Jobs | MBA Jobs | Java Jobs | SEO Jobs | SAP Jobs<br>
			...
			All Jobs-Walkin Jobs | Contract Jobs | Placement Jobs | Jobs for Women | Startup Jobs | International Jobs</p><br>    
<footer>
   <p id="p6"><strong>copyrights</strong><br>
