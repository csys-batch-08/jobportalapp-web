...
public class ApplyJob implements Serializable {
	...
	public ApplyJob(int applicantId, int postId, String applicantName, String qualification, String skill, int age,
			String email, String address, long phoneNumber, Date date) {
		this.applicantId = applicantId;
		this.postId = postId;
		this.applicantName = applicantName;
		this.qualification = qualification;
